...
//!   https://github.com/tinyhumansai/tinysearch/releases/tag/v0.1.4 \
//!   tinysearch-0.2.1-ubuntu-24.04-x86_64.tar.gz \
//!   <sha256>
//! ```
...
use tinysearch::{ListToolsResponse, names};
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let _reply: ListToolsResponse = proxy.call(names::methods::LIST_TOOLS, ()).await?;
